    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 md:px-8 text-center py-24">
        ...
        <ScrambleText
          ...
          className="font-heading font-black text-3xl md:text-5xl lg:text-6xl text-signal-white tracking-[-0.03em] uppercase leading-[0.95]"
        />
        <ScrambleText
          as="h2"
          text="IT'S A COMMAND."
          className="font-heading font-black text-3xl md:text-5xl lg:text-6xl text-ignition tracking-[-0.03em] uppercase leading-[0.95] mt-1"
          delay={300}
        />
