    ...
    >
      ...
      <div className="relative aspect-[4/5] overflow-hidden">
        <img
          ...
          alt={hero.name}
          className="w-full h-full object-cover opacity-90 dark:opacity-80 group-hover:opacity-70 dark:group-hover:opacity-50 group-hover:grayscale transition-all duration-1000 scale-105 group-hover:scale-100"
        />
        <div className="absolute inset-0 bg-gradient-to-t from-obsidian via-transparent dark:via-obsidian/20 to-transparent" />
